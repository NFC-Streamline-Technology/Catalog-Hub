...
@Component({
  ...
  template: `
    <div *ngIf="pagination.totalPages > 1" class="flex items-center justify-between bg-white px-4 py-3 sm:px-6 border-t border-gray-200">
      ...
      <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            >
              <span class="sr-only">{{ translate?.previous || 'Anterior' }}</span>
