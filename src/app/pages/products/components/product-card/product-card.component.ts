...
@Component({
  ...
  template: `
    <div class="card hover:shadow-md transition-shadow duration-200">
      ...
      <ng-template #noImage>
        <div
          class="w-full h-48 bg-gray-100 rounded-lg mb-4 flex items-center justify-center"
        >
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center justify-between text-sm">
          <span class="text-gray-500"
            >{{ translate?.fields?.category || "Categoria" }}:</span
          >
        ...
        >
          <span class="text-gray-500"
            >{{ translate?.fields?.brand || "Marca" }}:</span
          >
        ...
        <div class="flex space-x-2 pt-3 border-t border-gray-100">
          <button class="btn-secondary flex-1 text-sm" (click)="onEdit()">
            {{ translate?.generic?.edit || "Editar" }}
          </button>
          <button class="btn-danger flex-1 text-sm" (click)="onDelete()">
